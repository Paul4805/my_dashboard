...
from app.api import html_generation
from app.api import generate_analysis
...
app.include_router(html_generation.router)
app.include_router(generate_analysis.router)
